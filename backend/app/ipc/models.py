...
class IPCPrediction(BaseModel):
    """Model for storing user's IPC section predictions."""
    ...
    # List of PredictedSection objects
    predicted_sections: Mapped[list[dict]] = mapped_column(JSONB, nullable=False)
